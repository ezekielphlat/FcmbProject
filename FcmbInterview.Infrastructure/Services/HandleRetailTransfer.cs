...
{
    public class HandleRetailTransfer : ITransferHandler
    {
        ...
        public HandleRetailTransfer(ApplicationDbContext context, IReferenceNumberGenerator referenceNumberGenerator)
        {
        ...
        public async Task<bool> Handle(TransferRequest request)
        {
            ...
            var discountConfig = _context.Discount.Where(d => d.UserType.ToString() == RETAIL_USER_TYPE).SingleOrDefault();
            ...
            newTrans.SenderAccount = request.sourceAccount;
            newTrans.TransactionReferenceNumber = _referenceNumberGenerator.GetReferenceNumber(RETAIL_USER_TYPE);
